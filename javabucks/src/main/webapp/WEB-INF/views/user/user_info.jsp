...
<body>
    ...
    <section id="user_info" class="content">
        <div class="inner_wrap">
            ...
            <div class="edit_form">
                <form name="f" action="userInfo" method="post">
                    <div class="read_box">
                        <label>아이디
                    ...
                    <div class="edit_box">
                        <div class="nickname_box">
                            <p>닉네임설정</p>
                            <label>
                                <input type="text" name="userNickname" value="" placeholder="닉네임을 입력해주세요. (한글 최대 6자)">
                            </label>
                        </div>
                        <a class="toggle_btn" href="javascript:;">비밀번호 변경 ▽</a>
                        <div class="change_pw" style="display: block;">
                            <label>
                                <input type="password" name="userPasswd" value="" placeholder="새 비밀번호 (10~20자리 이내)">
                            </label>
                            <label>
                        ...
                        <div class="mail_box">
                            <p>이메일</p>
                            <label>
                                <input type="text" name="userEmail1" value="" placeholder="메일 입력">
                            </label>
                            @
                            <label>
